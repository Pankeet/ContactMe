...
export default function Contact(){
    ...
    return (
        <div className="font-serif ">
            <div className="sm:text-2xl md:text-3xl lg:text-5xl font-light pl-5 py-3 bg-[url('/banner.png')] bg-cover bg-no-repeat w-full text-xl">
                <div>Contact</div>
            </div>
            <div className="pt-10 sm:pl-10 pl-3 sm:flex">
                ...
                <div className="sm:text-2xl md:text-3xl md:font-medium lg:text-5xl sm:pl-52 pt-3">General <br />Inquiries</div>
                <div className="text-md sm:pl-44 sm:pt-10 pt-3"> For general inquiries please , please <i><u className="cursor-pointer" onClick={fillform}> <br /> fill out this form to reach me</u> </i>
                </div> 
            </div>
            <div className="sm:flex pl-3 sm:pt-20 pt-4 sm:pl-10 ">
                ...
                <span className="sm:pl-[21rem] pt-4 md:text-xl text-lg flex sm:block">First name<span className='text-red-900'>*</span> <br />
                ...
                <span className="sm:pl-36 pt-3.5 md:text-xl text-lg flex sm:block">Last name<span className='text-red-900'>*</span> <br />
            ...
            <div>
                <button type="submit" disabled={loading || coolingtime} onClick={sendMail} className={`${loading || coolingtime ? 'cursor-not-allowed' : 'cursor-pointer'} sm:ml-[50rem] mt-10 ml-44 px-6 py-2 mb-5 bg-black text-white text-lg rounded hover:bg-white transition-colors duration-300 hover:text-black `}>{loading ? "Sending Mail..." : "Send Mail"}</button>
            </div>
